...
const SKILLS = [
  ...
  { cmd:"/content-lab",  icon:"📊", label:"Content Lab",      desc:"Open the Content Lab tray — daily drafts, social posting", ph:"",                                              group:"Productivity" },
  { cmd:"/thoughts",     icon:"💭", label:"Thought Log",      desc:"Open Flow's internal reasoning log",                ph:"",                                                  group:"Productivity" },
  { cmd:"/leads",        icon:"💼", label:"Prospects",        desc:"Open the Leads/Prospects tray",                     ph:"",                                                  group:"Productivity" },
  ...
  { cmd:"/branch",   icon:"🌿", label:"Create Branch",  desc:"Create a new branch in any GitHub repo",                    ph:"dev  in flowpay   or   dev  from main  in flowpay",              group:"GitHub" },
  { cmd:"/pr",       icon:"🔀", label:"Create PR",       desc:"Open a pull request between branches",                      ph:"dev to main in flowpay  title: Add payment routes",             group:"GitHub" },
  { cmd:"/delete",   icon:"🗑️",  label:"Delete File",    desc:"Delete a file from a GitHub repo",                          ph:"src/old.js from flowpay",                                       group:"GitHub" },
  { cmd:"/branches", icon:"🌳", label:"List Branches",   desc:"See all branches in a repo",                                ph:"flowpay",                                                       group:"GitHub" },
